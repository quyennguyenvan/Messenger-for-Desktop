### Thank to 
Special thanks to the original project aluxian/Messenger-for-Desktop, which this codebase is based on and which provided much of the foundation for this app.
